...
export default class JavaScriptCompiler {
    ...
    private compile_class_block(statement: ClassBlock): Component {
        ...
        return new Component(`{\n${static_statements.join("")}\n${initializer_expressions.join("")}\n${constructor_string}\n${definition_statements.join("")}}`)
    }
    ...
    private compile_static_property_declaration(statement: StaticPropertyDeclaration): Component {
        return new Component(`static ${this.compile_assignment_expression(statement.expression, true, false, false)}`)
    }
