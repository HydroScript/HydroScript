...
export default class Compiler {
    ...
    private compile_identifier(expression: Identifier, is_main: boolean, suffix: boolean = true, block_root: boolean = false): string {
        ...
        if (force_init_var_option.kind != "Identifier" || (force_init_var_option.symbol != "true" && force_init_var_option.symbol != "false")) throw new HydroScriptCompileError("\"force_init_var\" option is not a valid numeric literal")
