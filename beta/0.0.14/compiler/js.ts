...
export default class JavaScriptCompiler {
    ...
    private compile_statement(statement: Statement, is_main: boolean, options?: Record<string, any>): string {
        ...
        switch (statement.kind) {
            ...
            case "ExistentialStatement":
                return this.compile_existential_statement(statement as ExistentialStatement)
            case "WhileStatement":
    ...
    private compile_existential_statement(statement: ExistentialStatement): string {
