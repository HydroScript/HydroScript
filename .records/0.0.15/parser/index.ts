...
export default class Parser {
    ...
    private parse_function_arguments_list(): Expression[] {
        ...
        while (!this.is_end() && this.at().type != TokenType.CloseParenthesis) args.push(this.parse_expression())
        return args
    ...
    private parse_comma_expression_list(expression?: Expression): Expression[] {
        ...
        const args = [ expression ? expression : this.parse_expression() ]
    ...
    private parse_class_literal(): ClassLiteral {
        ...
        if (this.at().type == TokenType.Colon) {
            this.eat()
            extending = this.parse_expression()
        }
    ...
    private parse_short_if_statement(statement: Statement): ShortIfStatement {
        ...
        const condition = !unless ? this.parse_expression() : {
            object: "Expression",
            kind: "LogicalNotExpression",
