...
export default class Parser {
    ...
    private parse_function_parameters(): Identifier[] {
        ...
        while (this.at().type == TokenType.Identifier && (this.next().type == TokenType.OpenCurlyBracket || this.next().type == TokenType.Identifier)) params.push(this.parse_identifier())
